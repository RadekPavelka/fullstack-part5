describe('Blog app', function() {
  ...
  describe('When logged in', function() {
    ...
    describe('and some blogs exist', function() {
      beforeEach(function () {
        cy.createBlog({ title: 'First blog', author: 'Peter File',url: 'first.com' })
        cy.createBlog({ title: 'Second blog', author: 'Tom Jones',url: 'second.com' })
        cy.createBlog({ title: 'Third blog', author: 'Rick Roll',url: 'third.clom' })
      })
